...
* creates a second, independent tidy data set with the average of each variable for each activity and each subject.  This data set is a text file, space delimited, with no row names (The file can be read into R with read.table, setting header as "TRUE").
